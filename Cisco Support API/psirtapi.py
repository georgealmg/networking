...
def psirtdata(header,os_dict):
    ...
    elif "ios" not in os_dict.keys():
        pass
    
    if "iosxe" in os_dict.keys():
    ...
    elif "iosxe" not in os_dict.keys():
        pass

    if "nxos" in os_dict.keys():
